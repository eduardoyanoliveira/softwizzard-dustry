...
export const listDepartmentActive= async(dispatch) => {
...
export const updateDepartment= async(dispatch, data, pk) => {
    const url = urlApi + `${[pk]}/`;
...
export const deleteDepartment= async(dispatch, pk, name) => {
    const url = urlApi + `${[pk]}/`;
