...
const urlApi = 'break_reasons/';

export const cleanState = (dispatch) => {
    dispatch({ type: types.CLEAN_STATE});
};

export const listBreakReason= async(dispatch) => {
...
export const listBreakReasonActive= async(dispatch) => {
...
export const createBreakReason= async(dispatch, data) => {
...
export const updateBreakReason= async(dispatch, data, pk) => {
    const url = urlApi + `${[pk]}/`;
...
export const deleteBreakReason= async(dispatch, pk, name) => {
    const url = urlApi + `${[pk]}/`;
