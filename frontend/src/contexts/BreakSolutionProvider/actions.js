...
const urlApi = 'break_solutions/';

export const cleanState = (dispatch) => {
    dispatch({ type: types.CLEAN_STATE});
};

export const listBreakSolution= async(dispatch) => {
...
export const listBreakSolutionActive= async(dispatch) => {
...
export const createBreakSolution= async(dispatch, data) => {
...
export const updateBreakSolution= async(dispatch, data, pk) => {
    const url = urlApi + `${[pk]}/`;
...
export const deleteBreakSolution= async(dispatch, pk, name) => {
    const url = urlApi + `${[pk]}/`;
